...
- **DB**: `scripts/clips.db` — Source of truth for clip metadata AND rotation history (run `givore_db.py reinit-clips` to re-import clips, `givore_db.py migrate-all` to import history)
